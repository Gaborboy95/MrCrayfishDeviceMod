...
public final class ApplicationManager
{
	...
	{
		Application application = GPSoft.proxy.registerApplication(identifier, clazz);
		if(application != null)
		{
	...
	{
		final Predicate<AppInfo> FILTER = info -> !info.isSystemApp() && (!GPSoft.proxy.hasAllowedApplications() || GPSoft.proxy.getAllowedApplications().contains(info));

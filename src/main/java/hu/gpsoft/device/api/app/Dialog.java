package hu.gpsoft.device.api.app;
...
import hu.gpsoft.device.api.app.component.Button;
...
import hu.gpsoft.device.api.task.Task;
...
import hu.gpsoft.device.core.Wrappable;
import hu.gpsoft.device.core.io.FileSystem;
import hu.gpsoft.device.core.network.NetworkDevice;
...
public abstract class Dialog extends Wrappable
{
	...
	public static class Message extends Dialog
	{
		...
		private hu.gpsoft.device.api.app.component.Button buttonPositive;
		...
		public void init(@Nullable NBTTagCompound intent)
		{
			...
			buttonPositive = new hu.gpsoft.device.api.app.component.Button(getWidth() - 41, getHeight() - 20, "Close");
	...
	public static class Confirmation extends Dialog
	{
		...
		private hu.gpsoft.device.api.app.component.Button buttonPositive;
		private hu.gpsoft.device.api.app.component.Button buttonNegative;
		...
		public void init(@Nullable NBTTagCompound intent)
		{
			...
			buttonPositive = new hu.gpsoft.device.api.app.component.Button(getWidth() - positiveWidth - DIVIDE_WIDTH, getHeight() - 20, positiveText);
			...
			buttonNegative = new hu.gpsoft.device.api.app.component.Button(getWidth() - DIVIDE_WIDTH - positiveWidth - DIVIDE_WIDTH - negativeWidth + 1, getHeight() - 20, negativeText);
	...
	public static class Input extends Dialog
	{
		...
		private hu.gpsoft.device.api.app.component.TextField textFieldInput;
		private hu.gpsoft.device.api.app.component.Button buttonPositive;
		private hu.gpsoft.device.api.app.component.Button buttonNegative;
		...
		public void init(@Nullable NBTTagCompound intent)
		{
			...
			textFieldInput = new hu.gpsoft.device.api.app.component.TextField(5, 5 + offset, getWidth() - 10);
		 ...
		 */
		@Nullable
		public hu.gpsoft.device.api.app.component.TextField getTextFieldInput()
		{
	...
	public static class OpenFile extends Dialog
	{
		...
		public void init(@Nullable NBTTagCompound intent)
		{
			...
			int positiveWidth = Minecraft.getMinecraft().fontRenderer.getStringWidth(positiveText);
			buttonPositive = new hu.gpsoft.device.api.app.component.Button(172, 106, positiveText);
			buttonPositive.setSize(positiveWidth + 10, 16);
			...
			int negativeWidth = Minecraft.getMinecraft().fontRenderer.getStringWidth(negativeText);
			buttonNegative = new hu.gpsoft.device.api.app.component.Button(125, 106, negativeText);
			buttonNegative.setSize(negativeWidth + 10, 16);
			buttonNegative.setClickListener((mouseX, mouseY, mouseButton) -> close());
	...
	public static class SaveFile extends Dialog
	{
		...
		private Layout main;
		private FileBrowser browser;
		private hu.gpsoft.device.api.app.component.TextField textFieldFileName;
		private hu.gpsoft.device.api.app.component.Button buttonPositive;
		private hu.gpsoft.device.api.app.component.Button buttonNegative;
		...
		public void init(@Nullable NBTTagCompound intent)
		{
			...
			buttonPositive = new hu.gpsoft.device.api.app.component.Button(172, 125, positiveText);
			buttonPositive.setClickListener((mouseX, mouseY, mouseButton) ->
			{
				if(mouseButton == 0)
				{
			...
			buttonNegative = new hu.gpsoft.device.api.app.component.Button(126, 125, negativeText);
			buttonNegative.setClickListener((mouseX, mouseY, mouseButton) -> close());
			main.addComponent(buttonNegative);

			textFieldFileName = new hu.gpsoft.device.api.app.component.TextField(26, 105, 180);
	...
	public static class Print extends Dialog
	{
		...
		private hu.gpsoft.device.api.app.component.Label labelMessage;
		private hu.gpsoft.device.api.app.component.Button buttonRefresh;
		private ItemList<NetworkDevice> itemListPrinters;
		private hu.gpsoft.device.api.app.component.Button buttonPrint;
		private hu.gpsoft.device.api.app.component.Button buttonCancel;
		private hu.gpsoft.device.api.app.component.Button buttonInfo;
		...
		public void init(@Nullable NBTTagCompound intent)
		{
			...
			labelMessage = new hu.gpsoft.device.api.app.component.Label("Select a Printer", 5, 5);
			layoutMain.addComponent(labelMessage);

			buttonRefresh = new hu.gpsoft.device.api.app.component.Button(131, 2, Icons.RELOAD);
			...
			buttonPrint = new hu.gpsoft.device.api.app.component.Button(98, 108, "Print", Icons.CHECK);
			...
			buttonCancel = new hu.gpsoft.device.api.app.component.Button(74, 108, Icons.CROSS);
			...
			buttonInfo = new hu.gpsoft.device.api.app.component.Button(5, 108, Icons.HELP);
		...
		private static class Info extends Dialog
		{
			...
			private hu.gpsoft.device.api.app.component.Image imagePaper;
			private hu.gpsoft.device.api.app.component.Label labelPaper;
			private hu.gpsoft.device.api.app.component.Label labelPosition;
			private hu.gpsoft.device.api.app.component.Button buttonClose;
			...
			public void init(@Nullable NBTTagCompound intent)
			{
				...
				labelName = new hu.gpsoft.device.api.app.component.Label(TextFormatting.GOLD.toString() + TextFormatting.BOLD.toString() + entry.getName(), 5, 5);
				layoutMain.addComponent(labelName);

				labelPaper = new hu.gpsoft.device.api.app.component.Label(TextFormatting.DARK_GRAY + "Paper: " + TextFormatting.RESET + Integer.toString(0), 5, 18); //TODO fix paper count
				...
				labelPosition = new hu.gpsoft.device.api.app.component.Label(position, 5, 30);

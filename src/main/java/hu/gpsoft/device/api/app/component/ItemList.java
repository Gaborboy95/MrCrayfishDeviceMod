package hu.gpsoft.device.api.app.component;
...
public class ItemList<E> extends Component implements Iterable<E>
{
	...
	protected java.awt.Button btnUp;
	protected java.awt.Button btnDown;
	...
	{
		btnUp = new java.awt.Button(left + width - 12, top, Icons.CHEVRON_UP);

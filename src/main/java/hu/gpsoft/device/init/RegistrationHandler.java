...
public class RegistrationHandler
{
    ...
    public static class Blocks
    {
        ...
        {
            GPSoft.getLogger().info("Registering blocks");
    ...
    public static class Items
    {
        ...
        {
            GPSoft.getLogger().info("Registering items");
    ...
    public static class Recipes
    {
        ...
        {
            GPSoft.getLogger().info("Registering recipes");
    ...
    public static class Models
    {
        ...
        {
            GPSoft.getLogger().info("Registering models");

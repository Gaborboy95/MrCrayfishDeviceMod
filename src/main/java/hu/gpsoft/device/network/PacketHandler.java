package hu.gpsoft.device.network;

import com.mrcrayfish.device.Reference;
import com.mrcrayfish.device.network.task.*;
import hu.gpsoft.device.Reference;
import hu.gpsoft.device.network.task.MessageRequest;
import hu.gpsoft.device.network.task.MessageResponse;
import hu.gpsoft.device.network.task.MessageSyncBlock;
import hu.gpsoft.device.network.task.MessageSyncConfig;

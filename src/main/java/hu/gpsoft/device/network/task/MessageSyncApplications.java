package hu.gpsoft.device.network.task;
...
public class MessageSyncApplications implements IMessage, IMessageHandler<MessageSyncApplications, MessageSyncApplications>
{
    ...
    public void fromBytes(ByteBuf buf)
    {
        ...
        for(int i = 0; i < size; i++)
        {
            ...
            {
                GPSoft.getLogger().error("Missing application '" + appId + "'");
            }
        }
    ...
    {
        ReflectionHelper.setPrivateValue(CommonProxy.class, GPSoft.proxy, message.allowedApps, "allowedApps");
        return null;
    }
}

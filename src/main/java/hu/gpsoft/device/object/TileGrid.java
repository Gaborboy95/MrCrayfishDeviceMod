package hu.gpsoft.device.object;
...
import hu.gpsoft.device.object.tiles.Tile;
...
{
	private hu.gpsoft.device.api.app.component.Label labelCurrentCategory;
	private hu.gpsoft.device.api.app.component.Button btnNextCategory;
	private hu.gpsoft.device.api.app.component.Button btnPrevCategory;
	...
	{
		labelCurrentCategory = new hu.gpsoft.device.api.app.component.Label("", left + 14, top + 2);
		layout.addComponent(labelCurrentCategory);
		
		btnNextCategory = new hu.gpsoft.device.api.app.component.Button(left + 81, top, Icons.CHEVRON_RIGHT);

package hu.gpsoft.device.programs.auction;
...
import hu.gpsoft.device.api.app.Dialog;
import hu.gpsoft.device.api.app.Layout;
import hu.gpsoft.device.api.app.component.Inventory;
import hu.gpsoft.device.api.app.component.ItemList;
import hu.gpsoft.device.api.app.component.Label;
import hu.gpsoft.device.api.app.component.NumberSelector;
import hu.gpsoft.device.api.app.listener.ClickListener;
import hu.gpsoft.device.api.app.renderer.ListItemRenderer;
import hu.gpsoft.device.api.task.TaskManager;
import hu.gpsoft.device.api.utils.BankUtil;
import hu.gpsoft.device.api.utils.RenderUtil;
import hu.gpsoft.device.programs.auction.object.AuctionItem;
import hu.gpsoft.device.programs.auction.task.TaskAddAuction;
import hu.gpsoft.device.programs.auction.task.TaskBuyItem;
...
public class ApplicationMineBay extends Application
{
	...
	private hu.gpsoft.device.api.app.component.Button buttonAddCancel;
	private hu.gpsoft.device.api.app.component.Button buttonAddNext;
	
	/* Set Amount and Price Layout */
	private Layout layoutAmountAndPrice;
	private hu.gpsoft.device.api.app.component.Label labelAmount;
	private NumberSelector selectorAmount;
	private hu.gpsoft.device.api.app.component.Label labelPrice;
	private NumberSelector selectorPrice;
	private hu.gpsoft.device.api.app.component.Button buttonAmountAndPriceBack;
	private hu.gpsoft.device.api.app.component.Button buttonAmountAndPriceCancel;
	private hu.gpsoft.device.api.app.component.Button buttonAmountAndPriceNext;
	
	/* Set Duration Layout */
	private Layout layoutDuration;
	private hu.gpsoft.device.api.app.component.Label labelHours;
	private hu.gpsoft.device.api.app.component.Label labelMinutes;
	private hu.gpsoft.device.api.app.component.Label labelSeconds;
	private NumberSelector selectorHours;
	private NumberSelector selectorMinutes;
	private NumberSelector selectorSeconds;
	private hu.gpsoft.device.api.app.component.Button buttonDurationBack;
	private hu.gpsoft.device.api.app.component.Button buttonDurationCancel;
	private hu.gpsoft.device.api.app.component.Button buttonDurationAdd;
	...
	{
		getCurrentLayout().setBackground(new Layout.Background()
		{
			@Override
		...
		hu.gpsoft.device.api.app.component.Button btnAddItem = new hu.gpsoft.device.api.app.component.Button(70, 5, "Add Item");
		...
		hu.gpsoft.device.api.app.component.Button btnViewItem = new hu.gpsoft.device.api.app.component.Button(135, 5, "Your Auctions");
		...
		hu.gpsoft.device.api.app.component.Label labelBalance = new hu.gpsoft.device.api.app.component.Label("Balance", 295, 3);
		labelBalance.setAlignment(hu.gpsoft.device.api.app.component.Label.ALIGN_RIGHT);
		super.addComponent(labelBalance);
		
		final hu.gpsoft.device.api.app.component.Label labelMoney = new hu.gpsoft.device.api.app.component.Label("$0", 295, 13);
		labelMoney.setAlignment(hu.gpsoft.device.api.app.component.Label.ALIGN_RIGHT);
		labelMoney.setScale(1);
		labelMoney.setShadow(false);
		super.addComponent(labelMoney);
		
		hu.gpsoft.device.api.app.component.Label labelCategories = new hu.gpsoft.device.api.app.component.Label("Categories", 5, 29);
		...
		hu.gpsoft.device.api.app.component.Label labelItems = new hu.gpsoft.device.api.app.component.Label("Items", 100, 29);
		...
		hu.gpsoft.device.api.app.component.Button btnBuy = new hu.gpsoft.device.api.app.component.Button(100, 127, "Buy");
		btnBuy.setSize(50, 15);
		btnBuy.setClickListener((mouseX, mouseY, mouseButton) ->
		{
            final hu.gpsoft.device.api.app.Dialog.Confirmation dialog = new hu.gpsoft.device.api.app.Dialog.Confirmation();
		...
		buttonAddCancel = new hu.gpsoft.device.api.app.component.Button(138, 4, MINEBAY_ASSESTS, 0, 12, 8, 8);
		...
		buttonAddNext = new hu.gpsoft.device.api.app.component.Button(154, 4, MINEBAY_ASSESTS, 16, 12, 8, 8);
		...
		buttonAmountAndPriceBack = new hu.gpsoft.device.api.app.component.Button(122, 4, MINEBAY_ASSESTS, 8, 12, 8, 8);
		...
		buttonAmountAndPriceCancel = new hu.gpsoft.device.api.app.component.Button(138, 4, MINEBAY_ASSESTS, 0, 12, 8, 8);
		...
		buttonAmountAndPriceNext = new hu.gpsoft.device.api.app.component.Button(154, 4, MINEBAY_ASSESTS, 16, 12, 8, 8);
		...
		labelAmount = new hu.gpsoft.device.api.app.component.Label("Amount", 16, 30);
		...
		labelPrice = new hu.gpsoft.device.api.app.component.Label("Price", 96, 30);
		...
		buttonDurationBack = new hu.gpsoft.device.api.app.component.Button(122, 4, MINEBAY_ASSESTS, 8, 12, 8, 8);
		...
		buttonDurationCancel = new hu.gpsoft.device.api.app.component.Button(138, 4, MINEBAY_ASSESTS, 0, 12, 8, 8);
		...
		buttonDurationAdd = new hu.gpsoft.device.api.app.component.Button(154, 4, MINEBAY_ASSESTS, 24, 12, 8, 8);
		buttonDurationAdd.setClickListener((mouseX, mouseY, mouseButton) ->
		{
            final hu.gpsoft.device.api.app.Dialog.Confirmation dialog = new Dialog.Confirmation();
...
restoreDefaultLayout();
		...
		labelHours = new hu.gpsoft.device.api.app.component.Label("Hrs", 45, 30);
		layoutDuration.addComponent(labelHours);
		
		labelMinutes = new hu.gpsoft.device.api.app.component.Label("Mins", 76, 30);

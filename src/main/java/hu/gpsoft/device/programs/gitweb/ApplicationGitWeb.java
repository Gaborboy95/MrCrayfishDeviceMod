package hu.gpsoft.device.programs.gitweb;
...
import hu.gpsoft.device.programs.gitweb.component.GitWebFrame;
import hu.gpsoft.device.programs.gitweb.layout.TextLayout;
...
public class ApplicationGitWeb extends Application
{
    ...
    private hu.gpsoft.device.api.app.component.Button btnSearch;
    private hu.gpsoft.device.api.app.component.Button btnHome;
    private hu.gpsoft.device.api.app.component.Button btnSettings;

    private GitWebFrame webFrame;
    private hu.gpsoft.device.api.app.component.TextField textFieldAddress;
    ...
    public void init(@Nullable NBTTagCompound intent)
    {
        ...
        textFieldAddress = new hu.gpsoft.device.api.app.component.TextField(2, 2, 304);
        ...
        btnSearch = new hu.gpsoft.device.api.app.component.Button(308, 2, 16, 16, Icons.ARROW_RIGHT);
        ...
        btnHome = new hu.gpsoft.device.api.app.component.Button(326, 2, 16, 16, Icons.HOME);

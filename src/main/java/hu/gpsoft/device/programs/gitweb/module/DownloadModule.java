...
public class DownloadModule extends Module
{
    ...
    public void generate(GitWebFrame frame, Layout layout, int width, Map<String, String> data)
    {
        ...
        int section = layout.width / 6;
        hu.gpsoft.device.api.app.component.Button button = new Button(0, 10, "Download", Icons.IMPORT);
        ...
        button.setClickListener((mouseX, mouseY, mouseButton) ->
        {
            try
            {
                ...
                hu.gpsoft.device.api.app.Dialog dialog = new Dialog.SaveFile(frame.getApp(), file);

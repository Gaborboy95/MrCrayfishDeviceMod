package hu.gpsoft.device.programs.system;
...
import hu.gpsoft.device.api.app.ScrollableLayout;
import hu.gpsoft.device.api.app.component.Button;
import hu.gpsoft.device.api.app.component.Spinner;
import hu.gpsoft.device.api.utils.OnlineRequest;
import hu.gpsoft.device.core.Laptop;
import hu.gpsoft.device.programs.system.component.AppGrid;
import hu.gpsoft.device.programs.system.layout.LayoutAppPage;
import hu.gpsoft.device.programs.system.layout.LayoutSearchApps;
import hu.gpsoft.device.programs.system.object.AppEntry;
import hu.gpsoft.device.programs.system.object.RemoteEntry;
...
public class ApplicationAppStore extends SystemApplication
{
	...
	public void init(@Nullable NBTTagCompound intent)
	{
		...
		hu.gpsoft.device.api.app.component.Image imageBanner = new hu.gpsoft.device.api.app.component.Image(0, 0, LAYOUT_WIDTH, 60);
		...
		hu.gpsoft.device.api.app.component.Button btnSearch = new hu.gpsoft.device.api.app.component.Button(5, 5, Icons.SEARCH);
		...
		hu.gpsoft.device.api.app.component.Button btnManageApps = new hu.gpsoft.device.api.app.component.Button(23, 5, Icons.HAMMER);
		btnManageApps.setToolTip("Manage Apps", "Manage your installed applications");
		homePageLayout.addComponent(btnManageApps);

		hu.gpsoft.device.api.app.component.Image image = new hu.gpsoft.device.api.app.component.Image(5, 33, 20, 20, Icons.SHOP);
		homePageLayout.addComponent(image);

		hu.gpsoft.device.api.app.component.Label labelBanner = new hu.gpsoft.device.api.app.component.Label("App Market", 32, 35);
		labelBanner.setScale(2);
		homePageLayout.addComponent(labelBanner);

		hu.gpsoft.device.api.app.component.Label labelCertified = new hu.gpsoft.device.api.app.component.Label(TextFormatting.WHITE + TextFormatting.BOLD.toString() + "Certified Apps", 10, 66);
		homePageLayout.addComponent(labelCertified);

		hu.gpsoft.device.api.app.component.Label labelCertifiedDesc = new hu.gpsoft.device.api.app.component.Label(TextFormatting.GRAY + "Verified by MrCrayfish", LAYOUT_WIDTH - 10, 66);
		labelCertifiedDesc.setAlignment(hu.gpsoft.device.api.app.Component.ALIGN_RIGHT);
		...
		hu.gpsoft.device.api.app.component.Label labelOther = new hu.gpsoft.device.api.app.component.Label(TextFormatting.WHITE + TextFormatting.BOLD.toString() + "Other Apps", 10, 178);
		homePageLayout.addComponent(labelOther);

		hu.gpsoft.device.api.app.component.Label labelOtherDesc = new hu.gpsoft.device.api.app.component.Label(TextFormatting.GRAY + "Community Created", LAYOUT_WIDTH - 10, 178);
	...
	public void openApplication(AppEntry entry)
	{
		...
		hu.gpsoft.device.api.app.component.Button btnPrevious = new Button(2, 2, Icons.ARROW_LEFT);

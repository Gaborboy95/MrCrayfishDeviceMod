...
import hu.gpsoft.device.api.app.component.CheckBox;
import hu.gpsoft.device.api.app.component.ComboBox;
import hu.gpsoft.device.api.app.renderer.ItemRenderer;
import hu.gpsoft.device.api.utils.RenderUtil;
import hu.gpsoft.device.core.Laptop;
import hu.gpsoft.device.core.Settings;
import hu.gpsoft.device.programs.system.component.Palette;
import hu.gpsoft.device.programs.system.object.ColorScheme;
...
{
	private hu.gpsoft.device.api.app.component.Button buttonPrevious;
	...
	private hu.gpsoft.device.api.app.component.Button buttonWallpaperLeft;
	private hu.gpsoft.device.api.app.component.Button buttonWallpaperRight;
	private hu.gpsoft.device.api.app.component.Button buttonWallpaperUrl;

	private Layout layoutColorScheme;
	private hu.gpsoft.device.api.app.component.Button buttonColorSchemeApply;
	...
	{
		buttonPrevious = new hu.gpsoft.device.api.app.component.Button(2, 2, Icons.ARROW_LEFT);
		...
		hu.gpsoft.device.api.app.component.Button buttonColorScheme = new hu.gpsoft.device.api.app.component.Button(5, 26, "Personalise", Icons.EDIT);
		...
		buttonWallpaperLeft = new hu.gpsoft.device.api.app.component.Button(135, 27, Icons.ARROW_LEFT);
		...
		buttonWallpaperRight = new hu.gpsoft.device.api.app.component.Button(165, 27, Icons.ARROW_RIGHT);
		...
		buttonWallpaperUrl = new hu.gpsoft.device.api.app.component.Button(135, 52, "Load", Icons.EARTH);
		...
		buttonWallpaperUrl.setClickListener((mouseX, mouseY, mouseButton) ->
		{
			...
			hu.gpsoft.device.api.app.Dialog dialog = new Dialog.Message("This feature has not be added yet!");
			openDialog(dialog);
        });
		layoutPersonalise.addComponent(buttonWallpaperUrl);

		hu.gpsoft.device.api.app.component.Button buttonReset = new hu.gpsoft.device.api.app.component.Button(6, 100, "Reset Color Scheme");

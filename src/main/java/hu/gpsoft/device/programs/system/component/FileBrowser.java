package hu.gpsoft.device.programs.system.component;
...
import hu.gpsoft.device.api.app.component.ComboBox;
...
import hu.gpsoft.device.api.app.listener.ItemClickListener;
import hu.gpsoft.device.api.app.renderer.ListItemRenderer;
import hu.gpsoft.device.api.io.Drive;
import hu.gpsoft.device.api.io.File;
import hu.gpsoft.device.api.io.Folder;
import hu.gpsoft.device.api.task.Callback;
...
import hu.gpsoft.device.core.Window;
import hu.gpsoft.device.core.Wrappable;
import hu.gpsoft.device.core.io.FileSystem;
import hu.gpsoft.device.core.io.task.TaskGetFiles;
import hu.gpsoft.device.core.io.task.TaskGetStructure;
import hu.gpsoft.device.core.io.task.TaskSetupFileBrowser;
 ...
 */
public class FileBrowser extends hu.gpsoft.device.api.app.Component
{
    ...
    private hu.gpsoft.device.api.app.component.Button btnPreviousFolder;
    private hu.gpsoft.device.api.app.component.Button btnNewFolder;
    private hu.gpsoft.device.api.app.component.Button btnRename;
    private hu.gpsoft.device.api.app.component.Button btnCopy;
    private hu.gpsoft.device.api.app.component.Button btnCut;
    private hu.gpsoft.device.api.app.component.Button btnPaste;
    private hu.gpsoft.device.api.app.component.Button btnDelete;

    private ComboBox.List<Drive> comboBoxDrive;
    private hu.gpsoft.device.api.app.component.Label labelPath;
    ...
    public void init(Layout layout)
    {
        ...
        btnPreviousFolder = new hu.gpsoft.device.api.app.component.Button(5, 2, Icons.ARROW_LEFT);
        ...
        btnNewFolder = new hu.gpsoft.device.api.app.component.Button(5, 25 + btnIndex * 20, Icons.NEW_FOLDER);
        ...
        btnRename = new hu.gpsoft.device.api.app.component.Button(5, 25 + btnIndex * 20, Icons.RENAME);
        ...
        if(mode == Mode.FULL)
        {
            ...
            btnCopy = new hu.gpsoft.device.api.app.component.Button(5, 25 + btnIndex * 20, Icons.COPY);
            ...
            btnCut = new hu.gpsoft.device.api.app.component.Button(5, 25 + btnIndex * 20, Icons.CUT);
            ...
            btnPaste = new hu.gpsoft.device.api.app.component.Button(5, 25 + btnIndex * 20, Icons.CLIPBOARD);
        ...
        btnDelete = new hu.gpsoft.device.api.app.component.Button(5, 25 + btnIndex * 20, Icons.TRASH);
    ...
    {
        hu.gpsoft.device.api.app.Dialog.Input dialog = new hu.gpsoft.device.api.app.Dialog.Input("Enter a name");
    ...
    private void deleteSelectedFile()
    {
        ...
        if(file != null)
        {
            if(file.isProtected())
            {
                ...
                hu.gpsoft.device.api.app.Dialog.Message dialog = new hu.gpsoft.device.api.app.Dialog.Message(message);
                wrappable.openDialog(dialog);
                return;
            }

            hu.gpsoft.device.api.app.Dialog.Confirmation dialog = new hu.gpsoft.device.api.app.Dialog.Confirmation();
    ...
    private void setClipboardFileToSelected()
    {
        ...
        {
            hu.gpsoft.device.api.app.Dialog.Message dialog = new hu.gpsoft.device.api.app.Dialog.Message("The file/folder you are trying to copy does not exist.");
            wrappable.openDialog(dialog);
        }
    }
    ...
    private void cutSelectedFile()
    {
        ...
        {
            hu.gpsoft.device.api.app.Dialog.Message dialog = new hu.gpsoft.device.api.app.Dialog.Message("The file/folder you are trying to cut does not exist.");
            wrappable.openDialog(dialog);
        }
    }
    ...
    private void pasteClipboardFile()
    {
        if(clipboardFile != null)
        {
            ...
            {
                hu.gpsoft.device.api.app.Dialog.Message dialog = new hu.gpsoft.device.api.app.Dialog.Message("Destination folder can't be a subfolder");
                wrappable.openDialog(dialog);
            }
        }
    }
    ...
    private void handleCopyCut(boolean override)
    {
        final Callback<FileSystem.Response> CALLBACK = (response, success) ->
        {
            ...
            {
                hu.gpsoft.device.api.app.Dialog.Confirmation dialog = new hu.gpsoft.device.api.app.Dialog.Confirmation("A file with the same name already exists in this directory. Do you want to override it?");
    ...
    {
        hu.gpsoft.device.api.app.Dialog.Message dialog = new Dialog.Message(message);

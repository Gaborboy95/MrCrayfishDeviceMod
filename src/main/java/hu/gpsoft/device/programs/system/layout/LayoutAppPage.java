package hu.gpsoft.device.programs.system.layout;
...
import hu.gpsoft.device.programs.system.component.SlideShow;
import hu.gpsoft.device.programs.system.object.AppEntry;
import hu.gpsoft.device.programs.system.object.LocalEntry;
...
public class LayoutAppPage extends Layout
{
    ...
    private hu.gpsoft.device.api.app.component.Image imageBanner;
    private hu.gpsoft.device.api.app.component.Image imageIcon;
    private hu.gpsoft.device.api.app.component.Label labelTitle;
    private hu.gpsoft.device.api.app.component.Label labelVersion;
    ...
    public void init()
    {
        ...
        imageBanner = new hu.gpsoft.device.api.app.component.Image(0, 0, 250, 40);
        ...
        if(entry instanceof LocalEntry)
        {
            ...
            imageIcon = new hu.gpsoft.device.api.app.component.Image(5, 26, 28, 28, info.getIconU(), info.getIconV(), 14, 14, 224, 224, Laptop.ICON_TEXTURES);
        }
        else if(entry instanceof RemoteEntry)
        {
            imageIcon = new hu.gpsoft.device.api.app.component.Image(5, 26, 28, 28, ApplicationAppStore.CERTIFIED_APPS_URL + "/assets/" + resource.getResourceDomain() + "/" + resource.getResourcePath() + "/icon.png");
        }
        ...
        if(store.certifiedApps.contains(entry))
        {
            ...
            hu.gpsoft.device.api.app.component.Image certifiedIcon = new hu.gpsoft.device.api.app.component.Image(38 + width + 3, 29, 20, 20, Icons.VERIFIED);
            this.addComponent(certifiedIcon);
        }
        labelTitle = new hu.gpsoft.device.api.app.component.Label(entry.getName(), 38, 32);
        ...
        labelVersion = new hu.gpsoft.device.api.app.component.Label(version, 38, 50);
        ...
        if(entry instanceof LocalEntry)
        {
            ...
            hu.gpsoft.device.api.app.component.Button btnInstall = new hu.gpsoft.device.api.app.component.Button(20, 2, installed ? "Delete" : "Install", installed ? Icons.CROSS : Icons.PLUS);
        ...
        {
            hu.gpsoft.device.api.app.component.Button btnDownload = new Button(20, 2, "Download", Icons.IMPORT);
    ...
    private void openWebLink(String url)
    {
        ...
        catch (Throwable throwable1)
        {
            ...
            GPSoft.getLogger().error("Couldn't open link: {}", (Object)(throwable == null ? "<UNKNOWN>" : throwable.getMessage()));
        }
    }
}
